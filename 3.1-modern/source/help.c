...
\n\
The " PREF_FILE_NAME " File\n\
\n\
The " PREF_FILE_NAME " (saved preferences) file is in the same format as an X resource \
...
to the " PREF_FILE_NAME " file, they will not be read, and NEdit modifies this file \
by overwriting it completely.  Note also that the contents of the " PREF_FILE_NAME " \
file take precedence over the values of X resources.  Using \
Save Defaults after moving the contents of your " PREF_FILE_NAME " file to your \
.Xdefaults file will re-create the " PREF_FILE_NAME " file, interfering with \
...
resource names, see your " PREF_FILE_NAME " file):\n\
\n\
